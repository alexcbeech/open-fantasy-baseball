...
export default function manifest(): MetadataRoute.Manifest {
  return {
    ...
    icons: [
      ...
      { src: "/icons/icon-maskable-v3-192.png", sizes: "192x192", type: "image/png", purpose: "maskable" },
      { src: "/icons/icon-maskable-v3-512.png", sizes: "512x512", type: "image/png", purpose: "maskable" },
    ],
    shortcuts: [
      {
        name: "My Teams",
